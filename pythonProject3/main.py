...
while True:
    ...
    img = cv2.flip(img, 1)
    black_image = np.zeros((720, 1080, 3), np.uint8)
    img = detector.findHands_test(img, black_image) #2023 temp
    #img = detector.findHands(img)
    lmList, bboxInfo = detector.findPosition(img) # 2023 temp
            ...
            if x < lmList[8][0] < x + w and y < lmList[8][1] < y + h: #when it touched
                ...
                if l < 30 and t_flag == 0:
                    ...
                    if button.text == "CLE":
                        ...
                        #ser.write(bytes(show_number, encoding='ascii')) # 2023 temp
                        ...
                        for button in buttonList:
                            ...
                            if x < lmList[8][0] < x + w and y < lmList[8][1] < y + h:  # when it touched
                                ...
                                if l < 30 and t_flag == 0:
                                    ...
                                    if button.text == "Y":
                                        phone_number += ","
                                        #ser.write(bytes(phone_number, encoding='ascii'))  # 2023 temp
                            ...
                            if x < lmList[8][0] < x + w and y < lmList[8][1] < y + h:  # when it touched
                                ...
                                if l < 30 and t_flag == 0:
                                    ...
                                    if button.text == "Y":
                                        ...
                                        phone_text = finalText
                                        phone_text += "."
                                        #ser.write(bytes(phone_text, encoding='ascii')) # 2023 temp
                                        #mode_changer = "/"
                                        #ser.write(bytes(mode_changer, encoding='ascii'))
                                        #mode_changer = ""
